...
import com.atguigu.gulimall.order.service.PmsAttrService;
...
public class PmsAttrController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:pmsattr:list")
    ...
    //@RequiresPermissions("order:pmsattr:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:pmsattr:save")
    ...
    //@RequiresPermissions("order:pmsattr:update")
    ...
    //@RequiresPermissions("order:pmsattr:delete")

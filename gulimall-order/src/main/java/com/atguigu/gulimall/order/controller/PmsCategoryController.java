...
import com.atguigu.gulimall.order.service.PmsCategoryService;
...
public class PmsCategoryController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:pmscategory:list")
    ...
    //@RequiresPermissions("order:pmscategory:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:pmscategory:save")
    ...
    //@RequiresPermissions("order:pmscategory:update")
    ...
    //@RequiresPermissions("order:pmscategory:delete")

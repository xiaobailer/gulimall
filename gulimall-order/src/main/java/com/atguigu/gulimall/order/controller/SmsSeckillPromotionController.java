...
import com.atguigu.gulimall.order.service.SmsSeckillPromotionService;
 ...
 */
@RestController
@RequestMapping("order/smsseckillpromotion")
public class SmsSeckillPromotionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:smsseckillpromotion:list")
    ...
    //@RequiresPermissions("order:smsseckillpromotion:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:smsseckillpromotion:save")
    ...
    //@RequiresPermissions("order:smsseckillpromotion:update")
    ...
    //@RequiresPermissions("order:smsseckillpromotion:delete")

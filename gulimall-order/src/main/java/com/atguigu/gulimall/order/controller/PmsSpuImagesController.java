...
import com.atguigu.gulimall.order.service.PmsSpuImagesService;
...
public class PmsSpuImagesController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:pmsspuimages:list")
    ...
    //@RequiresPermissions("order:pmsspuimages:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:pmsspuimages:save")
    ...
    //@RequiresPermissions("order:pmsspuimages:update")
    ...
    //@RequiresPermissions("order:pmsspuimages:delete")

...
import com.atguigu.gulimall.order.service.SmsSeckillSkuNoticeService;
...
public class SmsSeckillSkuNoticeController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:smsseckillskunotice:list")
    ...
    //@RequiresPermissions("order:smsseckillskunotice:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:smsseckillskunotice:save")
    ...
    //@RequiresPermissions("order:smsseckillskunotice:update")
    ...
    //@RequiresPermissions("order:smsseckillskunotice:delete")

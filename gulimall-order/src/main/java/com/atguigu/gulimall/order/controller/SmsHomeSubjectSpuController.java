 ...
 */
@RestController
@RequestMapping("order/smshomesubjectspu")
public class SmsHomeSubjectSpuController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:smshomesubjectspu:list")
    ...
    //@RequiresPermissions("order:smshomesubjectspu:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:smshomesubjectspu:save")
    ...
    //@RequiresPermissions("order:smshomesubjectspu:update")
    ...
    //@RequiresPermissions("order:smshomesubjectspu:delete")

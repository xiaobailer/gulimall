...
import com.atguigu.gulimall.order.service.PmsAttrGroupService;
...
public class PmsAttrGroupController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:pmsattrgroup:list")
    ...
    //@RequiresPermissions("order:pmsattrgroup:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:pmsattrgroup:save")
    ...
    //@RequiresPermissions("order:pmsattrgroup:update")
    ...
    //@RequiresPermissions("order:pmsattrgroup:delete")

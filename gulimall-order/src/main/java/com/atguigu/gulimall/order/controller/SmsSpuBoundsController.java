 ...
 */
@RestController
@RequestMapping("order/smsspubounds")
public class SmsSpuBoundsController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:smsspubounds:list")
    ...
    //@RequiresPermissions("order:smsspubounds:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:smsspubounds:save")
    ...
    //@RequiresPermissions("order:smsspubounds:update")
    ...
    //@RequiresPermissions("order:smsspubounds:delete")

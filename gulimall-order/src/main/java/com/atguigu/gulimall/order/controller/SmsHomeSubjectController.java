...
import com.atguigu.gulimall.order.service.SmsHomeSubjectService;
...
public class SmsHomeSubjectController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:smshomesubject:list")
    ...
    //@RequiresPermissions("order:smshomesubject:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:smshomesubject:save")
    ...
    //@RequiresPermissions("order:smshomesubject:update")
    ...
    //@RequiresPermissions("order:smshomesubject:delete")

...
import com.atguigu.gulimall.order.service.PmsSkuSaleAttrValueService;
...
public class PmsSkuSaleAttrValueController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:pmsskusaleattrvalue:list")
    ...
    //@RequiresPermissions("order:pmsskusaleattrvalue:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:pmsskusaleattrvalue:save")
    ...
    //@RequiresPermissions("order:pmsskusaleattrvalue:update")
    ...
    //@RequiresPermissions("order:pmsskusaleattrvalue:delete")

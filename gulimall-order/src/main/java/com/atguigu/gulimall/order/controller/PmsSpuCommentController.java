...
public class PmsSpuCommentController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:pmsspucomment:list")
    ...
    //@RequiresPermissions("order:pmsspucomment:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:pmsspucomment:save")
    ...
    //@RequiresPermissions("order:pmsspucomment:update")
    ...
    //@RequiresPermissions("order:pmsspucomment:delete")

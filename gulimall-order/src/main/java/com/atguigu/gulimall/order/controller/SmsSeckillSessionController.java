...
public class SmsSeckillSessionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:smsseckillsession:list")
    ...
    //@RequiresPermissions("order:smsseckillsession:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:smsseckillsession:save")
    ...
    //@RequiresPermissions("order:smsseckillsession:update")
    ...
    //@RequiresPermissions("order:smsseckillsession:delete")

 ...
 */
@RestController
@RequestMapping("order/smsskufullreduction")
public class SmsSkuFullReductionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:smsskufullreduction:list")
    ...
    //@RequiresPermissions("order:smsskufullreduction:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:smsskufullreduction:save")
    ...
    //@RequiresPermissions("order:smsskufullreduction:update")
    ...
    //@RequiresPermissions("order:smsskufullreduction:delete")

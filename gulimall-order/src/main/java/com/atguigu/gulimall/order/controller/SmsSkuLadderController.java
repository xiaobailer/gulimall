 ...
 */
@RestController
@RequestMapping("order/smsskuladder")
public class SmsSkuLadderController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:smsskuladder:list")
    ...
    //@RequiresPermissions("order:smsskuladder:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:smsskuladder:save")
    ...
    //@RequiresPermissions("order:smsskuladder:update")
    ...
    //@RequiresPermissions("order:smsskuladder:delete")

...
import com.atguigu.gulimall.order.service.PmsSpuInfoDescService;
...
public class PmsSpuInfoDescController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:pmsspuinfodesc:list")
    ...
    //@RequiresPermissions("order:pmsspuinfodesc:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:pmsspuinfodesc:save")
    ...
    //@RequiresPermissions("order:pmsspuinfodesc:update")
    ...
    //@RequiresPermissions("order:pmsspuinfodesc:delete")

...
import com.atguigu.gulimall.order.service.PmsSkuImagesService;
...
public class PmsSkuImagesController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("order:pmsskuimages:list")
    ...
    //@RequiresPermissions("order:pmsskuimages:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("order:pmsskuimages:save")
    ...
    //@RequiresPermissions("order:pmsskuimages:update")
    ...
    //@RequiresPermissions("order:pmsskuimages:delete")
